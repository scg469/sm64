...
#ifdef VERSION_CN
#define TEXT_STAR_DIFF 0xFA,0x9E,0xFF,
#define TEXT_UNFILLED_STAR 0xFD,0x9E,0xFF,
#else
...
#define TEXT_FILE_MARIO_A 0x01,0x3D,0x01,0x3E,0x01,0x3F,0x9E,0x0A,0xFF,
#define TEXT_FILE_MARIO_B 0x01,0x3D,0x01,0x3E,0x01,0x3F,0x9E,0x0B,0xFF,
#define TEXT_FILE_MARIO_C 0x01,0x3D,0x01,0x3E,0x01,0x3F,0x9E,0x0C,0xFF,
#define TEXT_FILE_MARIO_D 0x01,0x3D,0x01,0x3E,0x01,0x3F,0x9E,0x0D,0xFF,

// Menu Options
#define TEXT_SCORE 0x01,0x02,0x01,0x03,0xFF,
#define TEXT_COPY 0x01,0x1A,0x01,0x1B,0xFF,
#define TEXT_ERASE 0x01,0x1E,0x01,0x1F,0xFF,

// Sound Options
#define TEXT_STEREO 0x01,0x20,0x01,0x21,0x01,0x22,0xFF,
#define TEXT_MONO 0x01,0x23,0x01,0x22,0x01,0x24,0xFF,
#define TEXT_HEADSET 0x01,0x25,0x01,0x26,0xFF,

// Misc Menu Text
#define TEXT_SAVED_DATA_EXISTS 0x01,0x2A,0x01,0x2B,0x01,0x2C,0x01,0x01,0x01,0x2D,0x01,0x2E,0xFF,
#define TEXT_NO_SAVED_DATA_EXISTS 0x01,0x29,0x01,0x2A,0x01,0x2B,0x01,0x2C,0x01,0x01,0x01,0x2D,0x01,0x2E,0xFF,

// Inside a Menu
#define TEXT_RETURN 0x01,0x16,0x01,0x17,0xFF,
#define TEXT_CHECK_SCORE 0x01,0x18,0x01,0x19,0x01,0x02,0x01,0x03,0xFF,
#define TEXT_COPY_FILE_BUTTON 0x01,0x1A,0x01,0x1B,0x01,0x1C,0x01,0x1D,0xFF,
#define TEXT_ERASE_FILE_BUTTON 0x01,0x1E,0x01,0x1F,0x01,0x1C,0x01,0x1D,0xFF,

// Score Menu
#define TEXT_HI_SCORE 0x01,0x40,0x01,0x41,0x01,0x02,0x01,0x03,0xFF,
#define TEXT_MY_SCORE 0x01,0x00,0x01,0x01,0x01,0x02,0x01,0x03,0xFF,
#define TEXT_SCORE_MARIO_A 0x40,0x41,0x0A,0xFF,
#define TEXT_SCORE_MARIO_B 0x40,0x41,0x0B,0xFF,
#define TEXT_SCORE_MARIO_C 0x40,0x41,0x0C,0xFF,
#define TEXT_SCORE_MARIO_D 0x40,0x41,0x0D,0xFF,
...
// Copy Menu
#define TEXT_COPY_IT_TO_WHERE 0x01,0x1A,0x01,0x1B,0x01,0x2F,0x01,0x30,0x01,0x31,0xFF,
#define TEXT_COPYING_COMPLETED 0x01,0x1A,0x01,0x1B,0x01,0x32,0x01,0x33,0xFF,
#define TEXT_NO_FILE_TO_COPY_FROM 0x01,0x29,0x01,0x2A,0x01,0x34,0x01,0x1C,0x01,0x1D,0xFF,

// Erase Menu
#define TEXT_SURE 0x01,0x38,0x01,0x0E,0x01,0x39,0xF4,0xFF,
#define TEXT_YES 0x01,0x36,0xFF,
#define TEXT_NO 0x01,0x37,0xFF,
#define TEXT_FILE_MARIO_A_JUST_ERASED 0x01,0x1C,0x01,0x1D,0x01,0x3B,0x01,0x1E,0x01,0x1F,0xFF,

/**
 * Menus Text (Pause, Course Completed)
 */
// Main Courses
#define TEXT_COURSE 0x01,0x04,0x01,0x05,0xFF,
#define TEXT_MYSCORE TEXT_MY_SCORE
#define TEXT_CONTINUE 0x01,0x08,0x01,0x09,0xFF,
#define TEXT_EXIT_COURSE 0x01,0x06,0x01,0x07,0xFF,
#define TEXT_CAMERA_ANGLE_R 0x01,0x0A,0x01,0x0B,0x58,0x01,0x0C,0x01,0x0D,0x01,0x0E,0x01,0x0F,0x01,0x10,0xFF,

// Camera Options
#define TEXT_LAKITU_MARIO TEXT_EMPTY_STRING
#define TEXT_LAKITU_STOP TEXT_EMPTY_STRING
#define TEXT_NORMAL_UPCLOSE 0x01,0x11,0x01,0x12,0x01,0x13,0x01,0x14,0xFF,
#define TEXT_NORMAL_FIXED 0x01,0x15,0x01,0x0E,0x01,0x13,0x01,0x14,0xFF,

// Course Completed Misc Text
#define TEXT_CATCH 0x01,0x45,0x01,0x46,0xFF,
#define TEXT_CLEAR 0x01,0x47,0x01,0x1F,0xFF,
#define TEXT_HUD_HI_SCORE 0x6A, 0x6B, 0x6E, 0x6F, 0x72, 0x73, 0xFE, 0x6C, 0x6D, 0x70, 0x71, 0x74, 0x75, 0xFF

// Save Options
#define TEXT_SAVE_AND_CONTINUE 0x01,0x2B,0x01,0x2C,0x01,0x42,0x01,0x08,0x01,0x09,0xFF,
#define TEXT_SAVE_AND_QUIT 0x01,0x2B,0x01,0x2C,0x01,0x42,0x01,0x06,0x01,0x07,0xFF,
#define TEXT_CONTINUE_WITHOUT_SAVING 0x01,0x43,0x01,0x44,0x01,0x2B,0x01,0x2C,0xFF,

// File Score Menu Icons
#define TEXT_ARROW_L 0x52,0x9E,0x15,0xFF,
#define TEXT_R_ARROW 0x1B,0x9E,0x53,0xFF,
